...
//Closures are able to reference / access the parent scope. Since the function is using a closure (??), it is able to access the internal variable.
...
// console.log(cube.surfaceArea()); // 92
